...
Откройте [пример с карточками](/computer-science/example1/memory-leak.html).
...
Откройте [пример с setInterval](/computer-science/example2/memory-leak-set-interval.html). Проделайте
