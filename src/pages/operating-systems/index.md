...
localhost - имя, которое указывает на текущий компьютер. Обычно оно разрешается в loopback-адрес 127.0.0.1 для IPv4 или
::1 для IPv6.
...
npm run dev запускает script из package.json. Обычно этот script стартует dev server фреймворка или сборщика: Angular
CLI, Vite, Astro, Next.js и другие инструменты.
