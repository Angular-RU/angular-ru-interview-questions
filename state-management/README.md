...
immutability. Angular-specific применение вынесено в [Управление состоянием в Angular](../angular/README.md#управление-состоянием):
signals, scoped services, RxJS store services, NgRx/NGXS/Akita и facade pattern.
