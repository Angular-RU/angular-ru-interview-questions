...
- [Быстрый маршрут подготовки](#быстрый-маршрут-подготовки)
...
- [Angular](#angular)
  ...
  - [Testing](#testing)
  - [Angular coding questions](#angular-coding-questions)
  - [Angular libraries и design systems](#angular-libraries-и-design-systems)
  - [`sideEffects` в package.json и tree shaking](#sideeffects-в-packagejson-и-tree-shaking)
...
- [Примеры](#примеры)
- [Поиск работы и стратегия интервью](#поиск-работы-и-стратегия-интервью)
...
![img.png](assets/base/concurrency.png)
...
![img.png](assets/base/waterfall-vs-agile.png)
...
- [CSS Flexbox](./examples/css/flexbox/)
