...
Вопросы и практические задания для подготовки разработчиков к собеседованиям: инженерные основы, Frontend, Backend,
архитектура, инфраструктура, командная работа и карьера.

## Основы и инструменты

### Архитектура компьютера [<img src="public/logos/computer-science.svg" width="24" alt="Computer Science logo" />](public/logos/computer-science.svg)
...
### Linux [<img src="public/logos/linux.svg" width="24" alt="Linux logo" />](public/logos/linux.svg)
...
### Git [<img src="public/logos/git.svg" width="24" alt="Git logo" />](public/logos/git.svg)
...
### AI [<img src="public/logos/claude-icon.svg" width="24" alt="AI logo" />](public/logos/claude-icon.svg)
...
### HTML [<img src="public/logos/html5.svg" width="24" alt="HTML logo" />](public/logos/html5.svg)
...
### CSS [<img src="public/logos/css.svg" width="24" alt="CSS logo" />](public/logos/css.svg)
...
### JavaScript [<img src="public/logos/javascript.svg" width="24" alt="JavaScript logo" />](public/logos/javascript.svg)
...
### TypeScript [<img src="public/logos/typescript.svg" width="24" alt="TypeScript logo" />](public/logos/typescript.svg)
...
### Angular [<img src="public/logos/angular.svg" width="24" alt="Angular logo" />](public/logos/angular.svg)
...
- [Компоненты, директивы, сервисы и pipes](src/pages/angular/index.md#компоненты-директивы-сервисы-и-pipes)
- [Templates](src/pages/angular/index.md#templates)
- [Lifecycle и rendering](src/pages/angular/index.md#lifecycle-и-rendering)
- [Dependency Injection](src/pages/angular/index.md#dependency-injection)
...
### React [<img src="public/logos/react.svg" width="24" alt="React logo" />](public/logos/react.svg)
...
- [React Core](src/pages/react/index.md#react-core)
...
- [Package manager и monorepo](src/pages/react/index.md#package-manager-и-monorepo)
- [Routing и fullstack frameworks](src/pages/react/index.md#routing-и-fullstack-frameworks)
- [Управление состоянием (State Management)](src/pages/react/index.md#state-management)
- [Data fetching в React-стеках](src/pages/react/index.md#data-fetching-1)
- [Forms в React-стеках](src/pages/react/index.md#forms-1)
- [Styling и UI libraries](src/pages/react/index.md#styling-и-ui-libraries)
- [Animation и charts](src/pages/react/index.md#animation-и-charts)
- [Testing](src/pages/react/index.md#testing)
- [Auth, backend и database](src/pages/react/index.md#auth-backend-и-database)
- [Hosting](src/pages/react/index.md#hosting)
- [i18n, rich text, upload и drag and drop](src/pages/react/index.md#i18n-rich-text-upload-и-drag-and-drop)
...
### Node.js [<img src="public/logos/nodejs.svg" width="24" alt="Node.js logo" />](public/logos/nodejs.svg)
...
### Docker [<img src="public/logos/docker.svg" width="24" alt="Docker logo" />](public/logos/docker.svg)
...
### QA [<img src="public/logos/playwright.svg" width="24" alt="Playwright logo" />](public/logos/playwright.svg)
...
### DevOps [<img src="public/logos/gitlab.svg" width="24" alt="DevOps logo" />](public/logos/gitlab.svg)
...
- [Задачи по Angular](src/pages/angular/index.md#angular-coding-questions)
- [Практика по Angular frontend tasks](src/pages/angular/index.md#практика-по-angular-frontend-tasks)
- [CSS examples](src/pages/css/index.md#практика-по-css)
- [CSS layout и component tasks](src/pages/css/index.md#css-layout-и-component-tasks)
- [CSS Flexbox examples](public/examples/css/flexbox/index.html)
- [CSS Grid examples](public/examples/css/grid/index.html)
...
- [React example 1](public/examples/react/example1/index.html)
- [React example 2](public/examples/react/example2/index.html)
