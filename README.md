...
Big O показывает, как растут время выполнения и потребление памяти при увеличении входных данных.
...
На собеседовании важно оценить доминирующую операцию и объяснить компромисс между временем, памятью и читаемостью.
